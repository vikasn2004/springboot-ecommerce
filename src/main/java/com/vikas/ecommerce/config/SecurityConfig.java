    ...
    public SecurityFilterChain configure(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorizeRequests -> authorizeRequests
                        ...
                        .requestMatchers(HttpMethod.POST, "/ecommerce/category/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.GET, "/ecommerce/categories/**").hasAnyRole("ADMIN", "USER")
                        .requestMatchers(HttpMethod.DELETE, "/ecommerce/categories/**").hasRole("ADMIN")
                        ...
                        .requestMatchers(HttpMethod.POST,"/ecommerce/help/**").hasAnyRole("ADMIN", "USER")
                        .anyRequest()
                        .authenticated())
